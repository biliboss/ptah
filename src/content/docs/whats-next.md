---
title: What's next
description: Four next versions of agent-tts — streaming, cross-platform, voice cloning, and native Claude Code voice via MCP.
---

## TL;DR

v1.1 shipped multilingual code-switch: `MultiPiperEngine`, sentence-level language detection, `--lang auto|pt|en`, En Amy voice routing. **What follows is about reach, not plumbing.** Four themes pulled out of the v1.1 backlog and pointed at the audiences that will care.
