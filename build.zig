...
pub fn build(b: *std.Build) void {
    ...
    // v1.1: dedicated test steps for the new language detector and the
    // extended IPC parser. Both files own tests that exercise the
    // backward-compatible parsing path (v0.6 / v0.7 / v1.1) and the
    // sub-µs stopword detector.
